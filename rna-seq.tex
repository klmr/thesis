...
abundance of \mrna molecules, coding for individual proteins (the
...
probes, which hybridise to complementary target \mrna sequences. In order to
...
\paragraph{\abbr{rnaseq} sample preparation}
...
\paragraph{Computational processing of the sequencing information}
