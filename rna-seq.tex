...
\citep{Mortazavi:2008, Marioni:2008}\todo{how does size factor normalisation fit
.in?} However, actual expression data has been
...
\todo[inline]{Briefly describe overdispersion problem, and dispersion
estimation}
