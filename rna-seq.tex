...
not the only type of \rna that is polyadenylated. \citet{Cheng:2005} found that
a large fraction of non-coding \rna is equally polyadenylated and exported from
...
from the same distribution with the same mean.\todo{More detail?}
