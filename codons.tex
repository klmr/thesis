...
(\cref{fig:codons-project-outline,fig:codons-match-cartoon}).

\textfig{codons-project-outline}{body}{\textwidth}
    {Experimental setup.}
...
\marginpar{%
    \includegraphics[width=\marginparwidth]{codons-match-cartoon}
    \vspace{-\baselineskip}
\figcapof{codons-match-cartoon}{Cartoon of the four distributions.}{Each
    distribution (“matching”, “mismatching”, “GO” and “DE” corresponds to a
    comparison between the codons of a gene set and the anticodons of a sample.
    The cartoon shows how these were combined to obtain the distributions. Each
    sample condition has a different colour. \mrna transcripts in more vivid
    colours correspond to cell type specific transcripts.}}
