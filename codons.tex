...
proportionally more to the variation between two small sets than between two
large sets. If one wants to assert that deviations are nonrandom, one thus has
...
\Cref{fig:significant-go-term-cub-var} plots the codon usage variation of each
