...
forming only a part of the overall \pol3 transcriptome. In this chapter we
briefly interrogate other members of the \pol3 transcriptome.
...
while \trna transcription uses a type \abbrsc{II} transcription initiation,
other \pol3 targets use different types of initiation, due to their different
promoter and enhancer structure. These differences could have strong effects on
the binding profile of active \pol3 on the target loci.
...
libraries and the \pol3 \chip reveals that this may not be the case after all
