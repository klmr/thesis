...
\begin{enumerate}
    \item Why?
    \item How do I account for noise/input?
    \item What do classes of SINEs rather than individual loci tell us?
    \item How does expression change across development?
    \item Make a list of which classes are expressed highest, look for
        commonalities with \trna[s]
\end{enumerate}}
