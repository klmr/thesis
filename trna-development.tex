...
\textfloat{mrna-expression-change}{spill}{%
    ...
    down over the course of development, corresponding to either an up- or
...
\textfigtwo{mrna-pca}
    {\abbr{pca} of \abbr{mrna} gene expression per developmental stage.}
    {Rotations \num{1} and \num{2} of the correlation matrix of
    protein-coding gene expression in each developmental stage. The percentage
    on the axes shows the amount of variance explained by each rotation. Points
    corresponding to liver samples are coloured in red, points correspoding to
    brain samples are coloured in yellow; stages of development go from light
    colours to dark colours.}
    {mrna-de-matrix}
    {Number of differentially expressed \abbr{mrna} genes between stages.}
...
\textfigtwo{trna-counts}
    {Overview over \abbr{trna} gene expression change.}
    ...
    {Example of dynamically changing \abbr{trna} genes.}
...
to the tissue and developmental stage (\cref{fig:trna-pca}). The observed
...
\textfig{trna-pca}{body}{0.8\textwidth}
    {\abbr{pca} of \abbr{trna} gene expression per developmental stage.}
    {Rotations \num{1} and \num{2} of the correlation matrix of
    \trna gene expression in each developmental stage. The percentage on the
    axes shows the amount of variance explained by each rotation. Points
    corresponding to liver samples are coloured in red, points correspoding to
    brain samples are coloured in yellow; stages of development go from light
    colours to dark colours.}
...
codon’s frequency in the \mrna transcriptome as a fraction of the overall codon
...
\begin{table}[!ht]
    ...
    \tabcap{chip-contingency}
        {Contingency table of \abbr{chip} signal enrichment.}
        {}
\end{table}
...
\begin{table}[h!]
    ...
    {Enrichment of different \abbr{chip} targets near active \abbr{trna} genes.}
...
\begin{table}[h!]
    ...
    \tabcap{de-histone}
    {Enrichment of different \abbr{chip} targets near differentially expressed
    \abbr{trna} genes.}
    {Shown are the unajusted \(p\)-values for the hypothesis of no enrichment of
...
\textfloat{compensation}{spill}{%
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \subcaption{\label{fig:compensation-a}Isoacceptor \anticodon{CAG}
            \abbr{trna} gene expression levels in liver across development.\\\ }
    \end{minipage}
    ...
    \begin{minipage}{0.4\textwidth}
        ...
        \subcaption{\label{fig:compensation-b}Density curve of isoacceptor
            \anticodon{CAG} \abbr{trna} gene expression correlations.}
    \end{minipage}
    \par
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[height=6cm]{correlation-gcc}
        \subcaption{\label{fig:compensation-c}Isoacceptor \anticodon{GCC}
            \abbr{trna} gene expression levels in liver across development.\\\ }
    \end{minipage}
    \hspace{0.05\textwidth}%
    \begin{minipage}{0.4\textwidth}
        ...
        \subcaption{\label{fig:compensation-d}Density curve of isoacceptor
            \anticodon{GCC} \abbr{trna} gene expression correlations.}
    \end{minipage}}
    {\abbr{trna} gene expression is compensated at the anticodon isoacceptor
    level during mouse development.}
...
\begin{table}[h!]
    ...
    \begin{tabular}{@{}l@{}S@{}}
        ...
        \midrule
        \input{./data/compensation-evidence.tex}
        \bottomrule
    \end{tabular}
