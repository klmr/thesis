...
\begin{table}
    ...
    \tabcap{genetic-code}{The genetic code.}
        ...
        anticodon (“\textsc{a}”) and the thee-letter abbreviation of the
        corresponding amino acid (“\textsc{aa}”). \codon{AUG} additionally
        signals the start of translation. Not all anticodons actually exist in
        all species (adapted from \citet{Dos_Reis:2004}).}
\end{table}
