...
\begin{figure}
    \centering
    \makebox[\textwidth]{\includegraphics[width=\paperwidth]{dna-mock}}
    ...
    line connecting the backbones correspond to a nucleotide pair. The length of
    the gene is understated, the overwhelming majority of transcribed pieces of
    \dna are much longer (protein-coding genes being many hundred to thousands
    of base pairs long).}
\end{figure}
