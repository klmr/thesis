...
adapter molecules are called \define[{
    ...
    Annotated in \primaryname{} and \secondaryname{} are two structures called
    the \define{D arm} and \define{T arm}. After transcription, the precursor
    \trna undergoes chemical modification of some of its bases, which is not
    shown here. Structure predicted by \name{COVE} \citep{Eddy:1994}, rendered
    by \name{PseudoViewer 3} \citep{Byun:2009} and manually post-processed.}
}]{\trna}.
