...
adapter molecules are called \trna.{\trna}.

\trna[s]\marginpar{
    \vspace{-10ex}% Necessary to fix figure going over bottom of page.
    \includegraphics[width=\marginparwidth]{trna-asn}
    \figcapof{trna-asn}{\abbr{trna} secondary structure}{of an asparagine (Asn)
    carrying \abbr{trna}. The \abbr{trna} carries the anticodon \anticodon{GUU}
    in the middle of the anticodon loop, highlighted in \tertiaryname{}. The D
    loop and T loop are shown in \primaryname{} and \secondaryname{}. Base
    modifications of the \abbr{trna} are not shown here. Structure predicted by
...
cloverleaf, consisting of a stem and three loops: the \define{D loop}, the
\define{T loop} and the \define{anticodon loop}. The latter carries three
nucleotides in its centre that base pair with a specific codon, and thus form
the anticodon \citep{Dalluge:1997}.
...
\define{class II} \pol3 transcription initiation. Unlike for protein-coding
...
called the \define{A box} and \define{B box}, respectively. The A box starts
...
motifs. This leads to the binding of the \pol3 recruitment factor \tfiiib
...
to the association of \pol3 with the gene body, and the initiation of
...
\mmu (\abbr{grcm38}\todo[ref]{John: how do I cite this?!}), \num{432} different
