...
surrounding a start codon, which the bound \xtrna{Met}’s anticodon base-pairs
with \citep{Kozak:2002}.

There it is joined by the 60S subunit. The assembled ribosome then starts
pulling the \mrna transcript through a channel in its structure and
