...
new individual from a single cell in a process called \define{embryogenesis}.
...
consecutive nucleotides together to form non-overlapping \define{triplet codons}
...
\define{degenerate}: most amino acids can be encoded by more than a single
codon.
...
\define{class~\abbrsc{II}} \pol3 transcription initiation. Unlike protein-coding
...
recoding}, an altogether different translation mechanism. Furthermore, the
...
sequence surrounding a start codon, with which the bound \xtrna{Met}’s anticodon
...
\citep{Li:2014,Csardi:2014,Jovanovic:2015}.\todo{@John: I don’t think this is true}
...
difference in codon usage frequency or relative codon usage between sets of
